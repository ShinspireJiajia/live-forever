...
const SiteEventMockData = {
    ...
    registrations: [
        ...
        },
        {
            ...
            transaction_complete_time: null  // 線上交易完成時間（未繳費為 null）
        },
        {
            reg_id: '260107001',
            event_id: 'SE2026004',
        ...
        /* === 針對 MBR00312（我的活動）新增多筆狀態 === */
        {
            ...
            transaction_complete_time: null  // 免費不需交易
        },
        {
            reg_id: '260109003',
            event_id: 'SE2026005',
        ...
        },
        {
            ...
            transaction_complete_time: '2026-01-09T13:05:00'  // 線上交易完成時間
        },
        {
            reg_id: '260109005',
            event_id: 'SE2026001',
        ...
        // 新增付費活動已繳費範例（信用卡線上交易）
        {
            ...
            transaction_complete_time: '2026-01-10T09:05:32'  // 線上交易完成時間
        },
        // 新增付費活動已繳費範例（現金）
        {
            reg_id: '260109007',
            ...
            transaction_complete_time: null  // 現金交易不需線上時間
        },
        // 新增待退款範例
        {
            reg_id: '260109008',
            ...
            transaction_complete_time: '2026-01-11T14:05:18'  // 原交易完成時間
        },
        // 新增匯款未繳費範例
        {
            reg_id: '260109009',
            ...
            payment_deadline: '2026-01-19T23:59:59'  // 匯款繳費截止日
        },
        // 新增匯款已繳費範例
        {
            reg_id: '260109010',
            ...
            transaction_complete_time: '2026-01-13T14:20:00',
            payment_deadline: '2026-01-19T23:59:59'  // 匯款繳費截止日
        }
    ],
