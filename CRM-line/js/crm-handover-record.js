...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (btnClearSignInline) {
    btnClearSignInline.addEventListener('click', function () {
      ...
      try {
        localStorage.removeItem('crmHandoverSignature');
      } catch (e) {
  ...
  if (btnConfirmSign) {
    btnConfirmSign.addEventListener('click', function () {
      ...
      try {
        localStorage.setItem('crmHandoverSignature', dataUrl);
      } catch (e) {
  ...
  // 頁面載入時恢復已儲存的簽名
  var savedSignature = localStorage.getItem('crmHandoverSignature');
